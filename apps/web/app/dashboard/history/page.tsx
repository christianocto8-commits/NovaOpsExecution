  ...
  return (
    <main className="space-y-6 p-6">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Task History</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold text-slate-950">History workspace foundation ready.</p>
