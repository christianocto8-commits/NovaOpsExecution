...
export function ReportsWorkspace() {
  ...
  const periodControls = (
    <div className="inline-flex rounded-2xl border border-slate-200/80 bg-white p-1 shadow-sm">
      <button
        type="button"
        onClick={() => setPeriodDays(7)}
        className={`inline-flex min-h-[44px] items-center justify-center rounded-xl px-5 py-2 text-xs font-bold transition-all duration-200 active:scale-95 ${
          periodDays === 7
