...
export const formTemplates: FormTemplate[] = [
  {
    ...
    status: "Active",
    fields: [
      { id: "opening-bar-ready", label: "Bar area sudah bersih dan siap operasional?", type: "yes_no", required: true },
      { id: "opening-machine-ready", label: "Espresso machine sudah dipanaskan dan dicek?", type: "yes_no", required: true },
      { id: "opening-grinder-ready", label: "Grinder sudah bersih dan siap digunakan?", type: "yes_no", required: true },
  ...
  },
  {
    ...
    status: "Active",
    fields: [
      { id: "cleaning-machine", label: "Espresso machine sudah dibersihkan?", type: "yes_no", required: true },
      { id: "cleaning-grinder", label: "Grinder area sudah bersih?", type: "yes_no", required: true },
      { id: "cleaning-bar", label: "Bar top dan working area sudah clean?", type: "yes_no", required: true },
  ...
  },
  {
    ...
    status: "Active",
    fields: [
      { id: "audit-service", label: "Service flow berjalan sesuai standar?", type: "yes_no", required: true },
      { id: "audit-quality", label: "Produk sample sesuai standar kualitas?", type: "yes_no", required: true },
